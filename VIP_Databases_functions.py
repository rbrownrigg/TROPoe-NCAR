...
full_vip = ({
    ...
    'irs_min_noise_wnum':{'value': '500.,522,546,631,747,1439,1770,1884,2217,3000', 'comment': 'Wavenumber array [cm-1] for the minimum noise spectrum', 'default': True},
    'irs_min_noise_spec':{'value': '75.801,14.056, 3.283, 0.683, 0.530, 0.581, 0.822, 0.025, 0.023, 0.044', 'comment': 'Noise array [RU] for the minimum noise spectrum', 'default': True},
